...
describe('snakeCase', () => {
    ...
    test('should handle strings with multiple spaces and special characters', () => {
        expect(snakeCase('Hello   World! How are you?')).toBe('hello-world-how-are-you');
    });

    test('should handle strings with leading and trailing spaces', () => {
        expect(snakeCase('  Leading and trailing spaces  ')).toBe('leading-and-trailing-spaces');
    });
    ...
    test('should handle strings with numbers and underscores', () => {
        expect(snakeCase('Test String_123')).toBe('test-string123');
    });
});
